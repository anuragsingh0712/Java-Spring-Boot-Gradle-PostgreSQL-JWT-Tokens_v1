...
import com.example.app.service.WorkoutService;
...
@Tag(name = "Workouts", description = "Workout programs and member assignments")
public class WorkoutController {

  private final WorkoutService workoutService;

  @GetMapping
  @Operation(summary = "List all workouts (paginated)")
  public ResponseEntity<Page<Workout>> findAll(
      @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "20") int size) {
    return ResponseEntity.ok(workoutService.findAll(PageRequest.of(page, size)));
  }
  ...
  @Operation(summary = "Assign a new workout program (trainer or admin roles)")
  ...
  @PutMapping("/{id}")
  @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'GYM_ADMIN', 'BRANCH_MANAGER', 'TRAINER')")
  @Operation(summary = "Update a workout program (trainer or admin roles)")
  ...
  @DeleteMapping("/{id}")
  @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'GYM_ADMIN', 'BRANCH_MANAGER', 'TRAINER')")
  @Operation(summary = "Delete a workout program (trainer or admin roles)")
